  ...
  return (
    <>
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        <div className="lg:col-span-8 bg-white p-5 2xl:p-stack-lg rounded-xl shadow-sm border border-surface-variant relative overflow-hidden">
          <div className="relative z-10">
            <div className="flex items-start justify-between gap-4">
              <h2 className="text-[clamp(28px,2.4vw,40px)] leading-[1.12] font-bold tracking-[-0.03em] text-on-surface mb-2">
            ...
            <ul className="mb-5 max-w-2xl space-y-1 text-[clamp(15px,1.2vw,16px)] leading-snug text-on-surface-variant">
              <li className="flex gap-2">
                <span className="text-primary">•</span>
                <span>You can now choose topics before starting a learning session.</span>
              </li>

              <li className="flex gap-2">
                <span className="text-primary">•</span>
                <span>You can select one or multiple topics to practice.</span>
              </li>

              <li className="flex gap-2">
                <span className="text-primary">•</span>
                <span>You can choose a difficulty level that matches your goal.</span>
              </li>
            </ul>
